...
BEGIN_MESSAGE_MAP(CMFCApplication3Dlg, CDialogEx)
	...
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER1, &CMFCApplication3Dlg::OnNMCustomdrawSlider1)
END_MESSAGE_MAP()
...
void CMFCApplication3Dlg::OnNMCustomdrawSlider1(NMHDR* pNMHDR, LRESULT* pResult)
{
